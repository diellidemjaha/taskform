...
const AdminRegister = () => {
  ...
  const handleSubmit = async (e) => {
      ...
      try {
          ...
          Swal.fire({
            title: "OOPS !",
            html: "Something went wrong while registering admin !",
            timer: 2000,
            timerProgressBar: true,
            didOpen: () => {
              Swal.showLoading();
          ...
          <div className="col-md-6">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title text-center mb-4">Register as a Admin</h5>
                ...
                <p className="text-center mt-3">
                  Already have an account? <Link to="/admin-login">Login as Admin</Link>
                </p>
              </div>
            </div>
          </div>
